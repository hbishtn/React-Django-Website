...
from .views import google_login_view, quick_add_product, create_category, remove_background, edit_product, featured_products, set_featured_products, health_check, match_product_image
...
urlpatterns = [
    ...
    path('match-image/', match_product_image, name='match_product_image'),
