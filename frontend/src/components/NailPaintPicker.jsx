...
function NailPaintPicker() {
  ...
  const msg = 'Namaste! Mujhe ' + selected.name + ' shade ka nail paint chahiye, kya ye available hai?';
  const whatsappLink = 'https://wa.me/919410725209?text=' + encodeURIComponent(msg);
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          {shades.map((shade) => (
            <button
              ...
              style={{
                ...
                borderColor: selected.hex === shade.hex ? '#282C3F' : '#FFFFFF',
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 flex flex-col items-center sticky top-6">
          <svg width="140" height="220" viewBox="0 0 140 220">
            <rect x="50" y="10" width="40" height="35" rx="4" fill="#282C3F"></rect>
            <rect x="58" y="0" width="24" height="14" rx="3" fill="#282C3F"></rect>
            <rect x="55" y="45" width="30" height="15" fill="#DDDDDD"></rect>
            <path d="M40 60 Q40 60 40 75 L35 200 Q35 215 50 215 L90 215 Q105 215 105 200 L100 75 Q100 60 100 60 Z" fill="white" stroke="#D1D5DB" strokeWidth="2"></path>
            <path d="M40 90 L36 200 Q36 213 50 213 L90 213 Q104 213 104 200 L100 90 Z" fill={selected.hex} opacity="0.9"></path>
            <rect x="44" y="90" width="6" height="110" rx="3" fill="white" opacity="0.3"></rect>
          </svg>
